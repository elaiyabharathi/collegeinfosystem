...
class Staffupdate extends CI_Controller{
	...
	function index()
	{
			...
			$this->staffsignupmodel->update($_POST['email'],$_POST['name'],$_POST['bday'],$_POST['bmonth'],$_POST['byear'],$_POST['dept'],$_POST['sex'],$_POST['area of interest']);
