...
<link rel="stylesheet" type="text/css" media="all" href="/igniter/assets/css/style.css"/>
  ...
  <script type="text/javascript" charset="utf-8" src="/igniter/assets/js/jquery.leanModal.min.js"></script>
 		...
 		<link rel="stylesheet" href="/igniter/assets/css/styleforum.css"/>
<!-- <script type="text/javascript" src="/igniter/assets/js/jquery.js"></script>
<script type="text/javascript" src="/igniter/assets/js/script.js"></script> -->
  ...
  <div class="container">
    ...
    <li><br><a href="#" class="btn dropdown-toggle value" data-toggle="dropdown"><span ><blink><p style="color:white">Login</p></blink></span></a><br><br>
              <ul>
                 ...
                 <!--  <li><a href="#clubsmodal" class="dropdown" id="clubstrigger"><span>Admin</span></a></li> -->
              </ul>
  ...
  $('#clubstrigger').leanModal({ top: 115, overlay: 0.45, closeButton: ".hidemodal" });
	...
	<div id="wrapper">
			<div id="slider">
				...
				<div class="slide" style="background-image: url(/igniter/assets/images/img/ccegg.jpg);background-repeat:no-repeat;">
				...
				<div class="slide" style="background-image: url(/igniter/assets/images/img/college_hat.jpg);background-repeat:no-repeat;">
					
				</div>
		
				<div class="slide" style="background-image: url(/igniter/assets/images/img/forum.jpg);background-repeat:no-repeat;">
					<!-- <div class="slide-block">
