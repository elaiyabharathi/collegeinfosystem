...
<link type="text/css" rel="stylesheet" href="/igniter/assets/css/bootstrap.css"/>
	...
	<body onload="init()">
	 ...
	 <?php
      $db = new MongoClient();
      $query = $this->mongo_db->get_where('staff',array('staffid'=>$_SESSION['staffid']));?>
      <?php echo form_open('staffupdate');?>
      <table align="center">
     <form action="" method="post" class="form-control">
		...
		<tr><td>Name :</td>
		 ...
		 <tr><td><br></td></tr>
			<tr><td>Password : </td>
			<td colspan="3"><input type="password" id="password" name="password" value ="<?php echo $query[0]['password']?>" class="form-control"style="width:400px;"required/></td></tr>
		<tr><td><br></td></tr>`
		<tr><td>	Retype Password :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td colspan="3"> <input type="password" id="repass" name="repass" value ="<?php echo $query[0]['password']?>" class="form-control"style="width:400px;" required/></td></tr>
		<tr><td><br></td></tr>	<tr><td>Email : </td>
		...
		<td colspan="3"><input value ="" type="text" id="area of interest" name="area of interest" placeholder="Area of interest" class="form-control"required style="width:400px;"/></td></tr>
		</table><br>
   ...
   <div id="photo"  class="col-md-3 container">
   	<?php 		  echo '<img src="/igniter/assets/images/profilepic/'.$_SESSION['staffid'].'.jpg " width="160" height="190">';		  ?>   	  
